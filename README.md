...
* 使用说明
  1.  向./config/config.js 中的ProjectDirs修改需要打包的多页项目，例如：
      ['index', 'page1', 'page2', ...]
  2.  .src目录下创建相应的子目录，html文件名对应相应的.src/projectName/fileName.js文件

---

### 2018-04-02新增自动部署(shell脚本)，你可以在命令行中直接执行对应的命令:
...
### 2018-03-10新增`html-loader` ,你可以在html中引入src相对路径，比如:
